...
const getIcon = (iconKey: string) => {
    const iconClass = "h-6 w-6";
     switch (iconKey) {
        ...
        case 'finance':
          return <svg width="24" height="24" fill="currentColor" viewBox="0 0 16 16">
            <path d="M12.6.75h2.454l-5.36 14.5h-2.16L2.36.75h2.454l3.286 9.098L12.6.75ZM8.5 7a.5.5 0 0 1 .5.5v1a.5.5 0 0 1-1 0v-1a.5.5 0 0 1 .5-.5"/>
            <path d="M1 1a1 1 0 0 1 1-1h12a1 1 0 0 1 1 1v14a1 1 0 0 1-1 1H2a1 1 0 0 1-1-1V1zm13 0H2v14h12V1z"/>
          </svg>;
        case 'purchases':
          return <svg width="26" height="26" fill="currentColor" viewBox="0 0 16 16">
...
const Sidebar: React.FC<SidebarProps> = ({ activePage, setActivePage, isOpen, onClose, companyName }) => {
    ...
    // Safe access to user name for display
    ...
    return (
        <>
            ...
            {/* Sidebar Container */}
            <aside className={`
                fixed inset-y-0 left-0 z-50 w-64 bg-white dark:bg-gray-800 text-gray-800 dark:text-gray-200 flex flex-col 
            ...
            `}>
                ...
                <div className="p-4 border-t border-gray-200 dark:border-gray-700">
                    ...
                    <button
                        onClick={logout}
                        className="flex items-center justify-center w-full p-3 bg-red-500 hover:bg-red-600 text-white rounded-lg transition-colors duration-200"
                    >
